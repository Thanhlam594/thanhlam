                            ...
                            <div class="product-item1 product-xe">
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/giay-converse-nam-co-thap-02.jpg" alt="">
                                    </div>
                                ...
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/giay-louis-vuitton-lv-trainer-54-damier-ebene-multi-like-auth-1.jpg" alt="">
                                    </div>
                                    <div class="product-title">
                                        <h3>Gucci</h3>
                                        <p></p>
                                        <del>1,500,000<u>đ</u></del>
                                        <span>1,300,000 <u>đ</u></span>
                                    </div>
                                </div>
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/dior-x-kaw-b23-thap-co-sieu-cap-7-650x650.jpg" alt="">
                                    </div>
                                    <div class="product-title">
                                        <h3>giày dior</h3>
                                        <p></p>
                                        <del>1,080,000<u>đ</u></del>
                                        <span>950,000 <u>đ</u></span>
                                    </div>
                                </div>
                        </div>
                    ...
                    <div class="product2-toyota">
                        ...
                        <div class="product2-toyotaxe">
                            <div class="product-item1 product-xe">
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/giaydacaocap1.webp" alt="">
                                    </div>
                                    <div class="product-title">
                                        <h3>giày da cao cấp</h3>
                                        <p></p>
                                        <del>1,890,000<u>đ</u></del>
                                        <span>1,500,000 <u>đ</u></span>
                                    </div>
                                </div>
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/sụcda.jpg" alt="">
                                    </div>
                                    <div class="product-title">
                                        <h3>sục da gc</h3>
                                        <p></p>
                                        <del>1,650,000<u>đ</u></del>
                                        <span>1,350,000 <u>đ</u></span>
                                    </div>
                                </div>
                                <div class="productvios">
                                    <div class="image-product">
                                        <img src="../image/giaydaluoi.jpg" alt="">
                                    </div>
                                    <div class="product-title">
                                        <h3>da lười</h3>
                                        <p></p>
                                        <del>980,000<u>đ</u></del>
            ...
            <footer>
                ...
                <div class="footer2">
                    <div class="footer2-content">
                        ...
                        <p><i class="fa-solid fa-phone"></i>Hotline: 0867109895</p>
